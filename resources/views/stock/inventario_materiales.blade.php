@extends('layouts.app', [
'namePage' => 'Inventario Materiales',
'class' => 'sidebar-mini',
'activePage' => 'inventario_materiales',
])
        ...
        <div class="col-md-12" style="display:inline-block;float:left;">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> Inventario Materiales</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table" id='tabla_inv_materiales'>
                            <thead>
                                <tr>
                                    <th>Codigo</th>
                                    <th>Descripcion</th>
...
$('#guardar_inventario').on('click', function() {
    ...
    $('#tabla_inv_materiales tr').each(function() {
    ...
    $.ajax({
        type: "POST",
        url: "{{route('guardar_inventario_materiales')}}",
        data: {
            valores: filas,
            usuario: usuario
        },
