@extends('layouts.app', [
'namePage' => 'Costos por Producto',
'class' => 'sidebar-mini',
'activePage' => 'productos_costos',
])
        ...
        <div class="col-md-12" style="display:inline-block;float:left;">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Costos por Producto</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <button id="export" class="btn btn-primary btn-round" style="display:none; float:right"
                        onclick="exportTableToExcel('tabla_impresion')"><i
