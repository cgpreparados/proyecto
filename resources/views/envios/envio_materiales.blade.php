@extends('layouts.app', [
'namePage' => 'Envio Materiales',
'class' => 'sidebar-mini',
'activePage' => 'envio_materiales',
])
        ...
        <div class="col-md-12" style="display:inline-block;float:left;">
            <div class="card">
                <div class="card-header">
                    ...
                    <h4 class="card-title"> Facturar Materiales</h4>
                </div>
                <div class="card-header"> 
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="col-md-7" style="display:inline-block;float:left;">
                            ...
                            <div style="float:right;">
                                <button class="btn btn-primary btn-round" id="guardar_envio"><i
...
$('#material').change(function() {
    ...
    nuevaFila += "<td contenteditable='true'>" + precio + " </td>";
...
//----------------------------ELIMINAR MATERIALES DEL LISTADO DE ENVIOS---------------------------------//
...
//----------------------------GUARDAR ENVIO---------------------------------//
$('#guardar_envio').on('click', function() {
    ...
    $.ajax({
        type: "POST",
        url: "{{route('guardar_envio_materiales')}}",
        data: {
            valores: filas,
            user: user,
            fecha: fecha,
        ...
        success: function(r) {
            ...
            if (array.code == 1) {
                ...
                var url = "proyecto/public/factura/" + id_factura + "/1";
