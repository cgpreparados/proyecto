@extends('layouts.app', [
'namePage' => 'Envios Impresiones',
'class' => 'sidebar-mini',
'activePage' => 'envios_impresiones',
])
        ...
        <div class="col-md-12" style="display:inline-block;float:left;">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Envios Impresiones</h4>
                </div>
        ...
        success: function(r) {
            ...
            if (array.code == 1) {
                ...
                for (var i = 0; i < data_length; i++) {
                    ...
                    nuevaFila += "<tr>";
                    nuevaFila += "<td>" + array[i].id_envio + "</td>";
